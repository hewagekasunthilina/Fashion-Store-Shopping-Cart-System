    ...
    render() {
        return (
            <div className="align-items-center"
                 style={{margin: ".5rem", padding: ".5rem", backgroundColor: "#343A40", color: "#ffff"}}>
                    ...
                    <div className="card-body" style={{backgroundColor: "#343A40"}}>
                        ...
                        <div>
                            ...
                            <div className="form-group">
                                ...
                                <input ref={this.name} type="text" className="form-control"
                                       placeholder="Hashini Silva"/>
                            </div>
                            <div className="form-group">
                                <small>Card Number</small><br/>
                                <input ref={this.cardNumber} type="text" className="form-control"
                                       placeholder="42267896453"/>
                            </div>
                            <div className="form-group">
                                ...
                                <div className="row">
                                    <div className="col">
                                        ...
                                        <select ref={this.month}
                                                className="form-control">{Array.from(Array(12).keys()).map((elem, index) => {
                                            return (<option>{elem + 1}</option>)
                                        })} </select>
                                    </div>
                                    <div className="col">
                                        <small>Year</small><br/>
                                        <select ref={this.year}
                                                className="form-control">{[2020, 2021, 2022, 2023].map((year, index) => {
                            ...
                            <div className="form-group">
                                ...
                                <input ref={this.address} type="text" className="form-control" rows="3"
                                       placeholder="02, Park Street, Colombo 08"/>
                            </div>
                            <div className="form-group">
                                <small>Card Type</small><br/>
                                <div className="form-check form-check-inline">
                                    <input ref={this.cardTypeVisa} className="form-check-input" type="radio"
                                           name="cardType" id="visa" value="Visa"/>
                                    <label className="form-check-label" for="visa">Visa</label>
                                </div>
                                <div className="form-check form-check-inline">
                                    <input ref={this.cardTypeMaster} className="form-check-input" type="radio"
                                           name="cardType" id="master" value="Master"/>
