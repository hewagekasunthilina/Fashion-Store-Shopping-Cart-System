    ...
    onNavItemClick(e) {
        ...
        switch (clickedItem) {
            ...
            case "add-user":
                ...
                break;
            case "edit-users":
                this.props.goToPage("EditUsers");
                break;
            case "add-category":
                this.props.goToPage("AddCategoryPage");
                break;
            case "edit-categories":
                this.props.goToPage("EditCategoriesPage");
                break;
            case "wishlist":
        ...
        return (
          ...
          <span className="navbar-brand" href="#" style={{
            ...
            <span className="navbar-toggler-icon"></span>
                ...
                <span id="items" className="nav-link" href="#" style={{color: "#ffffff", marginTop: "-.2rem"}}
                      onClick={this.onNavItemClick}>
                  Items
                </span>
                            </li>
                            <li className="nav-item">
                <span id="add-user" className="nav-link" href="#" style={{color: "#ffffff", marginTop: "-.2rem"}}
                      onClick={this.onNavItemClick}>
                  Add Management User
                </span>
                            </li>
                            <li className="nav-item">
                <span id="edit-users" className="nav-link" href="#" style={{color: "#ffffff", marginTop: "-.2rem"}}
                      onClick={this.onNavItemClick}>
                  Edit Users
                </span>
                            </li>
                            <li className="nav-item">
                <span id="add-category" className="nav-link" href="#" style={{color: "#ffffff", marginTop: "-.2rem"}}
                      onClick={this.onNavItemClick}>
                  Add Category
                </span>
                            </li>
                            <li className="nav-item">
                <span id="edit-categories" className="nav-link" href="#" style={{color: "#ffffff", marginTop: "-.2rem"}}
                      onClick={this.onNavItemClick}>
                  Edit Categories
                </span>
                            </li>
                            <li className="nav-item">
                <span id="wishlist" className="nav-link" href="#" style={{color: "#ffffff", marginTop: "-.2rem"}}
                      onClick={this.onNavItemClick}>
                  Wish List
                </span>
                            </li>
