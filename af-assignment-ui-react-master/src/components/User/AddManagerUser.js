    ...
    render() {
        return (
            <div className="align-items-center justify-content-center row "
                 style={{margin: ".5rem", padding: ".5rem", width: "80rem"}}>
                <div className={this.state.cardClass} style={{backgroundColor: "#343A40", marginLeft: "12rem"}}>
                    <div className="card-body">
                        <div className="card-header"><h3 style={{textAlign: "center", color: "#fff"}}>Add New Store
                            Manager</h3></div>
                        <div>
                            ...
                            <div className="form-group">
                                ...
                                <input ref={this.email} type="text" className={this.state.emailClass}
                                       placeholder="gaya.perera@gmail.com"/>
                            </div>
                            <div className="form-group">
                                <small style={{color: "#fff"}}>Password</small><br/>
                                <input ref={this.password} type="password" className={this.state.passwordClass}
                                       placeholder="shush!"/>
                            </div>
                            <div className="form-group">
                        ...
                        <br/>
                        <button href="#" className="btn btn-primary btn-block" onClick={this.onAddUserBtnClick}>Add
                            User
                        </button>
                    </div>
                </div>
