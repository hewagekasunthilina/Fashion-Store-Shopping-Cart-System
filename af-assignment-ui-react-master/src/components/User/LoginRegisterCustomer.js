        ...
        return (
            <div className=" justify-content-center row col-md-12" style={{marginTop: "5rem"}}>
                <div className={this.state.regCardClass}
                     style={{margin: ".5rem", padding: ".5rem", backgroundColor: "#343A40"}}>
                    <div className="card-body">
                        <div className="card-header"><h3 style={{textAlign: "center", color: "#fff"}}>Register</h3>
                        </div>
                        <div>
                            ...
                            <div className="form-group">
                                ...
                                <input ref={this.regPassword} className={this.state.regPasswordInputClass}
                                       type="password" placeholder="shush!"/>
                            </div>
                        </div>
                        <br/>
                        <button href="#" className="btn btn-primary btn-block" onClick={this.onRegBtnClick}>Register
                        </button>
                    </div>
                </div>
                ...
                <div className={this.state.loginCardClass}
                    ...
                    <div className="card-body">
                        ...
                        <button href="#" className="btn btn-primary btn-block" style={{marginTop: "5rem"}}
                                onClick={this.onLoginBtnClick}>Login
                        </button>
                    </div>
                </div>
            </div>
